...
if __name__=='__main__':
  ...
  visualize(raw_data[idx], labels[idx], '2D t-SNE for Raw Data (After PCA-50)', os.path.join(opt.save_dir, 'raw_data.pdf'), pca_first=True)
  visualize(activations[idx], labels[idx], '2D t-SNE for Penultimate Layer Activations', os.path.join(opt.save_dir, 'activations.pdf'))
