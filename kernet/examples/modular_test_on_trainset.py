...
def modular_test(opt, model, loader):
  ...
  with open(os.path.join(opt.save_dir, f'modular_test_on_trainset_nexamples{opt.max_testset_size}.json'), 'w') as out:
...
if __name__ == '__main__':
  ...
  # TODO a hacky solution to load train set for testing
  opt.is_train = True
  opt.augment_data = False
  opt.max_trainset_size = opt.max_testset_size
  opt.shuffle = True
