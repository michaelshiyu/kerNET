...
class k3LeNet5(kLeNet5):
    def __init__(self, opt, centers=None, *args, **kwargs):
        ...
        if centers is not None:
            ...
            centers1 = utils.supervised_sample(
                centers[0], centers[1], opt.n_centers1).clone().detach()
    ...
    def update_centers(self):
        ...
        if self.fc1.evaluation == 'indirect':
            ...
            logger.debug('Updating centers for {} fc1...'.format(
                self.__class__.__name__))

            def update_fn(x): return self.conv2(self.conv1(x))
